!function(a) {
    "function" == typeof define && define.amd ? define(["jquery"], a) : "object" == typeof module && module.exports ? module.exports = function(b, c) {
        return "undefined" == typeof c && (c = "undefined" != typeof window ? require("jquery") : require("jquery")(b)),
        a(c),
        c
    }
    : a(jQuery)
    ...
    function b(b) {
        ...
        a(b.target).closest("form").ajaxSubmit(c))
    }
    function c(b) {
        var c = b.target
          , d = a(c);
    ...
    var e = /\r?\n/g
      , f = {};
    f.fileapi = void 0 !== a('<input type="file">').get(0).files,
    f.formdata = "undefined" != typeof window.FormData;
    var g = !!a.fn.prop;
    a.fn.attr2 = function() {
        if (!g)
    ...
    a.fn.ajaxSubmit = function(b, c, e, h) {
        ...
        function k(c) {
            ...
            function f() {
                ...
                var c = o.attr2("target")
                  ...
                  , i = o.attr("enctype") || o.attr("encoding") || g;
                ...
                try {
                    if (k.extraData)
                        for (var m in k.extraData)
                            k.extraData.hasOwnProperty(m) && (a.isPlainObject(k.extraData[m]) && k.extraData[m].hasOwnProperty("name") && k.extraData[m].hasOwnProperty("value") ? j.push(a('<input type="hidden" name="' + k.extraData[m].name + '">', z).val(k.extraData[m].value).appendTo(x)[0]) : j.push(a('<input type="hidden" name="' + m + '">', z).val(k.extraData[m]).appendTo(x)[0]));
            ...
            function h(b) {
                if (!r.aborted && !H) {
                    if (G = e(q),
                    G || (d("cannot access response document"),
                    b = C),
                    b === B && r)
                        return r.abort("timeout"),
                        void y.reject(r, "timeout");
                    if (b === C && r)
                        return r.abort("server abort"),
                        void y.reject(r, "error", "server abort");
                    if (G && G.location.href !== k.iframeSrc || v) {
                        q.detachEvent ? q.detachEvent("onload", h) : q.removeEventListener("load", h, !1);
                        var c, f = "success";
                        try {
                            if (v)
                                throw "timeout";
                            var g = "xml" === k.dataType || G.XMLDocument || a.isXMLDoc(G);
                            if (d("isXml=" + g),
                            !g && window.opera && (null === G.body || !G.body.innerHTML) && --I)
                                return d("requeing onLoad callback, DOM not available"),
                                void setTimeout(h, 250);
                            var i = G.body ? G.body : G.documentElement;
                            r.responseText = i ? i.innerHTML : null,
                            r.responseXML = G.XMLDocument ? G.XMLDocument : G,
                            g && (k.dataType = "xml"),
                            ...
                            if (l || k.textarea) {
                                ...
                                "xml" === j && !r.responseXML && r.responseText && (r.responseXML = J(r.responseText));
                            try {
                                F = L(r, j, k)
                            } catch (t) {
                                f = "parsererror",
                        ...
                        r.aborted && (d("upload aborted"),
                        f = null),
                        r.status && (f = r.status >= 200 && r.status < 300 || 304 === r.status ? "success" : "error"),
                        "success" === f ? (k.success && k.success.call(k.context, F, "success", r),
                        y.resolve(r.responseText, "success", r),
                        m && a.event.trigger("ajaxSuccess", [r, k])) : f && ("undefined" == typeof c && (c = r.statusText),
            ...
            c)
                for (j = 0; j < s.length; j++)
                    i = a(s[j]),
                    g ? i.prop("disabled", !1) : i.removeAttr("disabled");
            k = a.extend(!0, {}, a.ajaxSettings, b),
            k.context = k.context || k,
            n = "jqFormIO" + (new Date).getTime();
            var z = x.ownerDocument
              , A = o.closest("body");
            if (k.iframeTarget ? (p = a(k.iframeTarget, z),
            u = p.attr2("name"),
            u ? n = u : p.attr2("name", n)) : (p = a('<iframe name="' + n + '" src="' + k.iframeSrc + '" />', z),
            p.css({
                position: "absolute",
                top: "-1000px",
                left: "-1000px"
            ...
            t = x.clk,
            t && (u = t.name,
            u && !t.disabled && (k.extraData = k.extraData || {},
            k.extraData[u] = t.value,
            "image" === t.type && (k.extraData[u + ".x"] = x.clk_x,
            k.extraData[u + ".y"] = x.clk_y)));
            var B = 1
              , C = 2
              , D = a("meta[name=csrf-token]").attr("content")
              , E = a("meta[name=csrf-param]").attr("content");
            E && D && (k.extraData = k.extraData || {},
            k.extraData[E] = D),
            k.forceSync ? f() : setTimeout(f, 10);
            ...
            , L = function(b, c, d) {
                ...
                "string" == typeof g && (("json" === c || !c) && e.indexOf("json") >= 0 ? g = K(g) : ("script" === c || !c) && e.indexOf("javascript") >= 0 && a.globalEval(g)),
                g
            };
            return y
        }
        ...
        "function" == typeof h && (b.success = h)) : "undefined" == typeof b && (b = {}),
        ...
        var p = {};
        if (this.trigger("form-pre-serialize", [this, b, p]),
        p.veto)
        ...
        if (b.beforeSerialize && b.beforeSerialize(this, b) === !1)
            ...
            this;
        var q = b.traditional;
        "undefined" == typeof q && (q = a.ajaxSettings.traditional);
        ...
        if (b.beforeSubmit && b.beforeSubmit(t, this, b) === !1)
            ...
            this;
        if (this.trigger("form-submit-validate", [t, this, b, p]),
        p.veto)
            return d("ajaxSubmit: submit vetoed via form-submit-validate trigger"),
            this;
        var v = a.param(t, q);
        r && (v = v ? v + "&" + r : r),
        "GET" === b.type.toUpperCase() ? (b.url += (b.url.indexOf("?") >= 0 ? "&" : "?") + v,
        b.data = null) : b.data = v;
        var w = [];
        ...
        !b.dataType && b.target) {
            ...
            b.success && (a.isArray(b.success) ? a.merge(w, b.success) : w.push(b.success));
    ...
    a.fn.ajaxForm = function(e, f, g, h) {
        ...
        !e.delegation && 0 === this.length) {
            ...
            return !a.isReady && i.s ? (d("DOM not ready, queuing ajaxForm"),
            a(function() {
    ...
    a.fn.formToArray = function(b, c, d) {
        ...
        if (0 === this.length)
            return e;
        var g, h = this[0], i = this.attr("id"), j = b || "undefined" == typeof h.elements ? h.getElementsByTagName("*") : h.elements;
        if (j && (j = a.makeArray(j)),
        i && (b || /(Edge|Trident)\//.test(navigator.userAgent)) && (g = a(':input[form="' + i + '"]').get(),
        ...
        p = j.length; k < p; k++)
            ...
            m && !o.disabled)
                ...
                n && n.constructor === Array)
                    ...
                    null !== n && "undefined" != typeof n && (c && c.push(o),
                    e.push({
                        name: m,
                        value: n,
                        type: o.type,
        ...
        if (!b && h.clk) {
            var s = a(h.clk)
              , t = s[0];
            m = t.name,
            m && !t.disabled && "image" === t.type && (e.push({
                name: m,
                value: s.val()
            }),
            e.push({
    ...
    a.fieldValue = function(b, c) {
        ...
        c && (!d || b.disabled || "reset" === f || "button" === f || ("checkbox" === f || "radio" === f) && !b.checked || ("submit" === f || "image" === f) && b.form && b.form.clk !== b || "select" === g && b.selectedIndex === -1))
            return null;
        if ("select" === g) {
            var h = b.selectedIndex;
            if (h < 0)
                return null;
            for (var i = [], j = b.options, k = "select-one" === f, l = k ? h + 1 : j.length, m = k ? h : 0; m < l; m++) {
                var n = j[m];
